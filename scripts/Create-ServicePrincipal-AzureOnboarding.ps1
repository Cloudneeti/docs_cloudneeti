...
.EXAMPLE
    ...
    4. Creates a Service Principal with the expiry date.
        .\Create-ServicePrincipal-AzureOnboarding.ps1 -activeDirectoryId xxxxxxx-xxxx-xxxx-xxxx-xxxxxxx -expirationPeriod <1year, 2year, NeverExpires>
